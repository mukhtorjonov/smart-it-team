<template>
  <div class="container mx-auto p-8 pt-20">
    <div class="max-w-lg mx-auto bg-white rounded-lg shadow-lg p-6">
      <h2 class="text-2xl font-bold mb-6 text-center">Mahsulot Qo'shish</h2>
      <form @submit.prevent="submitForm" enctype="multipart/form-data">
        <div class="mb-4">
          <label for="name" class="block text-gray-700 font-bold mb-2">Mahsulot Nomi:</label>
        ...
        <div class="mb-4">
          <label for="catigory_id" class="block text-gray-700 font-bold mb-2">Kategoriya:</label>
          <select id="catigory_id" v-model="category_id" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600" r>
        ...
        <div class="mb-4">
          <label for="price" class="block text-gray-700 font-bold mb-2">Narxi (UZS):</label>
          <input type="number" id="price" v-model="price" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
        <div class="mb-6">
          <label for="image" class="block text-gray-700 font-bold mb-2">Rasm yuklash:</label>
          <input type="file" id="image" @change="onFileChange" name="image" class="w-full px-3 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600" required>
        </div>
